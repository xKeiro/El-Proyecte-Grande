...
public static class AppDbInitializer
{
    ...
    public static void Seed(IApplicationBuilder applicationBuilder)
    {
        ...
        // Ingredients
        var penne = new Ingredient { Name = "Penne Pasta", UnitOfMeasure = "g" };
        var tomato = new Ingredient { Name = "Tomatoes", UnitOfMeasure = "g" };
        var basil = new Ingredient { Name = "Basil", UnitOfMeasure = "g" };
        var parmesan = new Ingredient { Name = "Parmesan", UnitOfMeasure = "g" };
        var chicken = new Ingredient { Name = "Chicken Breast", UnitOfMeasure = "g" };
        var romanianLettuce = new Ingredient { Name = "Romanian Lettuce", UnitOfMeasure = "bunch" };
        var flour = new Ingredient { Name = "Flour", UnitOfMeasure = "g" };
        var sugar = new Ingredient { Name = "Sugar", UnitOfMeasure = "g" };
        var eggs = new Ingredient { Name = "Eggs", UnitOfMeasure = "piece" };
        var chocolateChip = new Ingredient { Name = "Chocolate Chip", UnitOfMeasure = "g" };
        var onion = new Ingredient { Name = "Onion", UnitOfMeasure = "piece" };
